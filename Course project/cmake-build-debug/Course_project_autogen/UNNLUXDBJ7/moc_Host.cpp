...
QT_MOC_LITERAL(4, 38, 12), // "startFailure"
QT_MOC_LITERAL(5, 51, 13), // "sendVotingEnd"
QT_MOC_LITERAL(6, 65, 11), // "traitHandle"
QT_MOC_LITERAL(7, 77, 18), // "broadcastTheHostIP"
QT_MOC_LITERAL(8, 96, 17), // "generateCharacter"
QT_MOC_LITERAL(9, 114, 9), // "Character"
QT_MOC_LITERAL(10, 124, 22), // "generateEmptyCharacter"
QT_MOC_LITERAL(11, 147, 11) // "startVoting"

    },
    "Host\0giveTurnToHost\0\0everyoneIsInGame\0"
    "startFailure\0sendVotingEnd\0traitHandle\0"
    "broadcastTheHostIP\0generateCharacter\0"
    "Character\0generateEmptyCharacter\0"
    "startVoting"
};
...
void Host::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->startFailure(); break;
        case 3: _t->sendVotingEnd(); break;
        case 4: _t->traitHandle(); break;
        case 5: _t->broadcastTheHostIP(); break;
        case 6: { Character _r = _t->generateCharacter();
            if (_a[0]) *reinterpret_cast< Character*>(_a[0]) = std::move(_r); }  break;
        case 7: { Character _r = _t->generateEmptyCharacter();
            if (_a[0]) *reinterpret_cast< Character*>(_a[0]) = std::move(_r); }  break;
        case 8: _t->startVoting(); break;
        default: ;
        }
        ...
        {
            using _t = void (Host::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Host::startFailure)) {
                *result = 2;
                return;
            }
        }
