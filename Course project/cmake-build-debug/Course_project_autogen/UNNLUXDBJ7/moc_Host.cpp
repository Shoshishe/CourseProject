...
QT_MOC_LITERAL(3, 21, 13), // "sendVotingEnd"
QT_MOC_LITERAL(4, 35, 11), // "traitHandle"
QT_MOC_LITERAL(5, 47, 18), // "broadcastTheHostIP"
QT_MOC_LITERAL(6, 66, 17), // "generateCharacter"
QT_MOC_LITERAL(7, 84, 9), // "Character"
QT_MOC_LITERAL(8, 94, 22), // "generateEmptyCharacter"
QT_MOC_LITERAL(9, 117, 11) // "startVoting"

    },
    "Host\0giveTurnToHost\0\0sendVotingEnd\0"
    "traitHandle\0broadcastTheHostIP\0"
...
void Host::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->sendVotingEnd(); break;
        case 2: _t->traitHandle(); break;
        case 3: _t->broadcastTheHostIP(); break;
        case 4: { Character _r = _t->generateCharacter();
            if (_a[0]) *reinterpret_cast< Character*>(_a[0]) = std::move(_r); }  break;
        case 5: { Character _r = _t->generateEmptyCharacter();
            if (_a[0]) *reinterpret_cast< Character*>(_a[0]) = std::move(_r); }  break;
        case 6: _t->startVoting(); break;
        default: ;
        }
