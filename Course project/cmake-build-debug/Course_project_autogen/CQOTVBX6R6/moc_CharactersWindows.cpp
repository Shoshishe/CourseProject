...
QT_MOC_LITERAL(5, 47, 18) // "changeToNextPlayer"

    },
    "CharactersWindows\0traitSent\0\0turnMade\0"
    "voteMade\0changeToNextPlayer"
};
...
void CharactersWindows::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->changeToNextPlayer(); break;
        default: ;
        }
        ...
        {
            using _t = void (CharactersWindows::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CharactersWindows::changeToNextPlayer)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void CharactersWindows::changeToNextPlayer()
{
